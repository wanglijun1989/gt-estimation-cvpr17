...
model_weights = [caffe_root 'models/cvpr17-ILT-pretrain-fs/ip-1_iter_8000.caffemodel'];
...
model_def = [caffe_root 'examples/cvpr17-ILT-pretrain-fs/deploy.prototxt'];
phase = 'test';
...
subplot(1,2,2);imagesc(bsxfun(@times, im2double(resized_im), double(mat2gray(y) > 0.5)));
